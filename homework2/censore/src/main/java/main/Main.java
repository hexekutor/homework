...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Integer start = 10;
        Integer size = 4;
        InputStream textStream = Main.class.getClassLoader().getResourceAsStream("text.txt");
        InputStream exceptionStream = Main.class.getClassLoader().getResourceAsStream("exception.txt");
